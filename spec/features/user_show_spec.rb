...
RSpec.describe "User Show features" do
    ...
    it "shows a users 3  most recent posts" do
        mike = User.create(name: 'Mike', photo: 'https://man.jpg', bio: 'Teacher from Poland.', postscounter: 9)
        post1 = Post.create(user: mike, title: 'Post 1', text: 'text for 1', postscounter: 6 , likescounter: 5 , commentscounter: 2)
        post2 = Post.create(user: mike, title: 'Post 2', text: 'text for 2', postscounter: 6 , likescounter: 5 , commentscounter: 2)
        post3 = Post.create(user: mike, title: 'Post 3', text: 'text for 3', postscounter: 6 , likescounter: 5 , commentscounter: 2)
        post4 = Post.create(user: mike, title: 'Post 4', text: 'text for 4', postscounter: 6 , likescounter: 5 , commentscounter: 2)
